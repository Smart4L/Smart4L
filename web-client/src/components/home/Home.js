...
export const Home = forwardRef((props, ref) => {
    ...
    useEffect(() => { setTemperature(props.exteriorTemp) }, [props.exteriorTemp])
    useEffect(() => { setHumidityExt(props.humidity) }, [props.humidity])
    ...
    return(
        <div className="home_container">
            <div className="home_item left_home_container">
                ...
                <span className="circle" onClick={() => startUp()}> 
